...
create_dataset_table <- function(dataset_index) {
  ...
  for (yl in 1:length(yardline_ranges)) {
    ...
    if (has_valid_results) {
      ...
      df[7, yardline] <- if(dataset_controls$game_situation) "Yes" else "No"
      df[8, yardline] <- if(dataset_controls$environmental) "Yes" else "No"
      df[9, yardline] <- if(dataset_controls$coach) "Yes" else "No"
      df[10, yardline] <- if(dataset_controls$team_stats) "Yes" else "No"
      df[11, yardline] <- if(dataset_controls$player_vars) "Yes" else "No"
      df[12, yardline] <- if(dataset_controls$player_presence) "Yes" else "No"
      df[13, yardline] <- if(dataset_controls$team_fe) "Yes" else "No"
      ...
      df[10, yardline] <- "No"
      df[11, yardline] <- "No"
      df[12, yardline] <- "Yes"  # Default player_presence to Yes
      df[13, yardline] <- "No"
      df[14, yardline] <- "No"
      df[15, yardline] <- "---"
    }
