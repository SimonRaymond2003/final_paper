...
```{r off-p-sum, fig.cap="Key Data Summary", out.width="100%"}
...
### Individual Player Offensive Grades Model Results
...
### Individual Player Defensive Grades Model Results
...
### Offense Joint Significance Results
...
### Defense Joint Significance Results
...
### Differences in Model Coeficients

```{r offense-grades-table-diffs, fig.cap="Offense Grades Differences Table", out.width="100%"}
knitr::include_graphics("table_images/off1.5.png")
```

\newpage

```{r defense-grades-table-diffs, fig.cap="Defense Grades Differences Table", out.width="100%"}
knitr::include_graphics("table_images/def1.5.png")
```

\newpage

```{r offense-grades-table-diffs2, fig.cap="Offense Player Grades Joint Significance Differences Table", out.width="100%"}
knitr::include_graphics("table_images/off2.5.png")
```

```{r defense-grades-table-diffs2, fig.cap="Defense Player Grades Joint Significance Differences Table", out.width="100%"}
knitr::include_graphics("table_images/def2.5.png")
```

```{r offense-grades-table-diffs3, fig.cap="Offense Grades Joint Significance Differences Table", out.width="100%"}
knitr::include_graphics("table_images/off3.5.png")
```

```{r defense-grades-table-diffs3, fig.cap="Defense Grades Joint Significance Differences Table", out.width="100%"}
knitr::include_graphics("table_images/def3.5.png")
```
...
In terms of the defense there is not enough evidence to make statements about individual player features' significance. However, when we test for joint significance of the defensive players there is signs of significance with the Defensive Line and Cornerbacks. Coaches then only produce weakly significant linear results with their attempt model for Cornerbacks. The decision to attempt a fourth down is seen to completely overlook the quality of a teams Starting linebacker core.
