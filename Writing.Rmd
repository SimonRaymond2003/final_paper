...
\begin{table}[ht]
\centering
\caption{Offense Player Grades Joint Significance Differences Table}
\includegraphics[width=\textwidth]{table_images/off2.5.png}
\end{table}
```
...
\begin{table}[ht]
\centering
\caption{Offense Grades Joint Significance Differences Table}
\includegraphics[width=\textwidth]{table_images/off3.5.png}
\end{table}
```
...
\begin{table}[ht]
\centering
\caption{Defense Player Grades Joint Significance Differences Table}
\includegraphics[width=\textwidth]{table_images/def2.5.png}
\end{table}
```
...
\begin{table}[ht]
\centering
\caption{Defense Grades Joint Significance Differences Table}
\includegraphics[width=\textwidth]{table_images/def3.5.png}
\end{table}
```
