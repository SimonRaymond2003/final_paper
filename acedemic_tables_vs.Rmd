...
# Function to rename present variables in matrices to a pattern that won't match position prefixes
...
for (dataset_idx in 1:length(dataset_names)) {
  ...
  for (model_type in model_types) {
    table_colnames <- c(table_colnames, 
                       paste0("Starter vs On-Field (", model_type, ")"),
                       paste0("Starter vs Attempt (", model_type, ")"),
                       paste0("On-Field vs Attempt (", model_type, ")"))
  }
