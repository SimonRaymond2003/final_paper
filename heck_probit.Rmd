...
run_heckman <- function(select_data, outcome_data, n_validation = n_validation) {
 ...
 # Data preparation
  ...
  # Train probit model
  probit_model <- glm(y ~ ., data = rf_data, family = binomial(link = "probit"))
  
  # Get probability predictions (z) for ALL data
  z <- predict(probit_model, rf_data, type = "response")  # Get probabilities
  ...
  #make gimr just completly be random
  GIMR <- rnorm(nrow(rf_data))
...
if (!dir.exists("matrices2")) {
  dir.create("matrices2")
}

# For T-values
write.csv(off_grades_tval, "matrices2/off_grades_tval.csv", row.names = TRUE)
write.csv(off_yards_tval, "matrices2/off_yards_tval.csv", row.names = TRUE)
write.csv(off_completions_tval, "matrices2/off_completions_tval.csv", row.names = TRUE)
write.csv(def_stops_tval, "matrices2/def_stops_tval.csv", row.names = TRUE)
write.csv(def_grades_tval, "matrices2/def_grades_tval.csv", row.names = TRUE)
write.csv(def_tackles_tval, "matrices2/def_tackles_tval.csv", row.names = TRUE)

# For Marginal Effects
write.csv(off_grades_mfx, "matrices2/off_grades_mfx.csv", row.names = TRUE)
write.csv(off_yards_mfx, "matrices2/off_yards_mfx.csv", row.names = TRUE)
write.csv(off_completions_mfx, "matrices2/off_completions_mfx.csv", row.names = TRUE)
write.csv(def_stops_mfx, "matrices2/def_stops_mfx.csv", row.names = TRUE)
write.csv(def_grades_mfx, "matrices2/def_grades_mfx.csv", row.names = TRUE)
write.csv(def_tackles_mfx, "matrices2/def_tackles_mfx.csv", row.names = TRUE)

# For Standard Errors
write.csv(off_grades_se, "matrices2/off_grades_se.csv", row.names = TRUE)
write.csv(off_yards_se, "matrices2/off_yards_se.csv", row.names = TRUE)
write.csv(off_completions_se, "matrices2/off_completions_se.csv", row.names = TRUE)
write.csv(def_stops_se, "matrices2/def_stops_se.csv", row.names = TRUE)
write.csv(def_grades_se, "matrices2/def_grades_se.csv", row.names = TRUE)
write.csv(def_tackles_se, "matrices2/def_tackles_se.csv", row.names = TRUE)

cat("All matrices saved to the 'matrices2' directory.\n")
```
...
write.csv(off_grades_vif, "matrices2/off_grades_vif.csv", row.names = TRUE)
write.csv(off_yards_vif, "matrices2/off_yards_vif.csv", row.names = TRUE)
write.csv(off_completions_vif, "matrices2/off_completions_vif.csv", row.names = TRUE)
write.csv(def_stops_vif, "matrices2/def_stops_vif.csv", row.names = TRUE)
write.csv(def_grades_vif, "matrices2/def_grades_vif.csv", row.names = TRUE)
write.csv(def_tackles_vif, "matrices2/def_tackles_vif.csv", row.names = TRUE)

cat("All VIF matrices saved to the 'matrices2' directory.\n")
